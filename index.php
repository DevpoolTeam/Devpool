...
<body>
	<div class="wrapper">
		...
		<div class="mainmenu">
			<div class="mainmenu1"><a href="#"> Kreiraj novu anketu </a></div>
			<div class="mainmenu2"><a href="#"> Administracija ankete </a></div>
			<div class="mainmenu3"><a href="#"> Pregled odgovora </a></div>
			<div class="mainmenu4"><a href="#"> Podijeli anketu </a></div>
		</div>
